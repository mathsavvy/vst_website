...
import { TimetvService } from './hometv.service';
...
@Component({
  selector: 'vedic-hometv',
  templateUrl: './hometv.component.html',
  styleUrls: ['./hometv.component.scss'],
})
export class HometvComponent implements OnInit, OnDestroy {
  ...
  constructor(private timeService: TimetvService) {}
